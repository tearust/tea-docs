...
*Only 1.52% of developers commonly use Solidity, a specialized language for Ethereum smart contracts according to a [Stack Overflow dev survey](https://survey.stackoverflow.co/2022/#most-popular-technologies-language-prof)*
